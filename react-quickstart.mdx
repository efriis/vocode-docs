...
Our React library only works with our hosted conversations right now, self-hosting is coming soon!
So, you'll need to get an API key from our [dashboard](https://app.vocode.dev/) to get started.
